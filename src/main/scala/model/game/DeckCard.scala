...
object DeckCard {
  def apply(id: String, imageNumber: Int,  belongingSet:Option[SetType], name: String, rarity: String, count: Int ): DeckCard = DeckCardImpl(id, imageNumber,belongingSet, name, rarity, count)
